...
def run_eval(config: dict, checkpoint: Optional[str]):
    ...
    runner_cfg = {
        ...
        "enumeration_method": config.get("runner", {}).get("enumeration_method", "hybrid"),
        "max_path_length": config.get("runner", {}).get("max_path_length", 4),
        "beam_width": config.get("runner", {}).get("beam_width", 4),
        "kg_file": config.get("data", {}).get("kg_file"),
        "llm_mode": config.get("llm", {}).get("mode", "heuristic"),
        "model_name_or_path": config.get("llm", {}).get("model_name_or_path", "gpt2"),
    }
